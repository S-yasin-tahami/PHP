...
<html>
   ...
   <?php
      ...
      if(isset($_POST['logout']) and $_SESSION['login'] == True){
      ...
      <form id="login_form" action="login.php" method="POST">      
         ...
         <div class="form-group">
            ...
            <div class="input-group">
               ...
               <input type="text" name="username"  class="form-control" placeholder="Enter Your Username" value="<?php echo htmlspecialchars($username); ?>">
            </div>  
         ...
         <div class="form-group">
            ...
            <div class="input-group">
               ...
               <input type="password"  name="password" class="form-control" placeholder="Enter Your password"  value="<?php echo htmlspecialchars($password); ?>" >
            </div>
            <div class="text-danger"><?php echo $errors['password']?></div>
         </div>

         <br>
         <button class="btn btn-outline-secondary" type="submit" name="login" value="login" >Login</button> <br><br>
